...
const Flechettes = () => {
  ...
  const handleClick = (value) => {
    ...
    if (currentPlayer === "Joueur1") setPointsJ1(prev => prev + value);
    else if (currentPlayer === "Joueur2") setPointsJ2(prev => prev + value);
    else if (currentPlayer === "Joueur3") setPointsJ3(prev => prev + value);
    else if (currentPlayer === "Joueur4") setPointsJ4(prev => prev + value);
    ...
    <>
      ...
      <div className="dartboard-container" style={isStarted ? { display: 'block' } : { display: 'none' }}>
        ...
        <div className="keyboard">
          ...
          <div className="row">
            <div className="btn double" onClick={()=>handleClick(50)}>Double</div>
            <div className="btn triple" onClick={()=>handleClick(60)}>Triple</div>
